...
_CHAPTER_IDS = ["starthere", "whatsnew", "summary", "flowcharts", "scale", "midi", "analyze", "sampler", "lm", "presets", "radio", "extract", "quality", "lrc", "video", "dawguide", "ch1", "ch2", "ch3", "ch4", "ch5", "ch6", "ch7", "ch8"]
